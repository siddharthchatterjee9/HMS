...
if(isset($_POST['patsub1']))
{
  ...
  $query="delete from patreg where email='$patmail';";
  $result=mysqli_query($con,$query);
  if($result)
    {
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Pediatrician" name="spec">Ophthalmologist</option>
                    </select>
                    </div><br><br>
      ...
      <div class="tab-pane fade" id="list-settings2" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
          
                  <div class="col-md-4"><label>Email ID:</label></div>
                  <div class="col-md-8"><input type="email"  class="form-control" name="patmail" required></div><br><br>
